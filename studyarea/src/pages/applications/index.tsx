...
const getStatusUpDate = (status: any) => {
...
const index = () => {
  ...
  const filteredApplications = data.filter((application:any) => {
    ...
    return searchMatch && application.status.toLocaleLowerCase() === Filter;
  });
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm">
          ...
          <div className="border-b border-gray-200 px-6 py-4">
            <h1 className="text-2xl font-bold text-purple-600">Applications</h1>
              ...
              <tbody>
                {filteredApplications.map((application: any) => (
                  <tr key={application._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusUpDate(
                          application.status
                        )}`}
                      >
                        {application.status}
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <div className="flex items-center space-x-3">
                        ...
                        <button
                          onClick={()=>handelAcceptandReject(application._id,"accepted")}
                          className="text-green-600 hover:text-green-900"
                        >
                          <CheckCircle2 className="h-5 w-5" />
                        </button>
                        <button
                          onClick={()=>handelAcceptandReject(application._id,"rejected")}
