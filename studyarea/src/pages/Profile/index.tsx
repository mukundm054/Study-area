        ...
        <div className="bg-gray-900 rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="pt-16 pb-8 px-6">
            <div className="text-center mb-8">
                <h1 className="text-2xl font-bold text-purple-600">{user?.email}</h1>
            ...
            <div className="space-y-6">
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div className="bg-blue-50 rounded-lg p-4 text-center">
                        ...
                        <p className="text-blue-600 text-sm mt-1">Active Application</p>
                    </div>
                ...
                > View Applications<ExternalLink className="ml-2 h-4 w-4" /> </Link>
                </div>
